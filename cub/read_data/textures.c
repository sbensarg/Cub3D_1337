...
/*   Updated: 2021/01/07 17:17:54 by sbensarg         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if ((g_texture[0].img = mlx_xpm_file_to_image(g_data.mlx_ptr, g_data_cub.we,
	...
	if ((g_texture[1].img = mlx_xpm_file_to_image(g_data.mlx_ptr, g_data_cub.no,
	...
	if ((g_texture[2].img = mlx_xpm_file_to_image(g_data.mlx_ptr, g_data_cub.ea,
	...
	if ((g_texture[3].img = mlx_xpm_file_to_image(g_data.mlx_ptr, g_data_cub.so,
